...
<html>
<head>
  <title>Vote for Grampanchayat</title>
<!--linking-->
...
// Fetching Data for Vidhansabha
 $UserGrampanchayat="SELECT * from usersignup where User_Email='".$_SESSION['UserName']."' LIMIT 1";
    ...
    $UserGrampanchayatContituency=$row['User_GrampanchayatConstituency'];
    $UserGrampanchayatWard=$row['User_GrampanchayatWardNumber'];
// Users Locsabhaconstituency is fetched Now List Of members fetching     
    $sql="SELECT * from addmember where SelectElectionName='Grampanchayat' AND ConstituencyName='$UserGrampanchayatContituency' AND CandidateWardNumber='$UserGrampanchayatWard'";
...
if (isset($_POST['CastVote'])) {
    ...
    $row = mysqli_fetch_assoc($UserData);
    $UserGrampanchayatContituency=$row['User_GrampanchayatConstituency'];
    $UserGrampanchayatDistrict=$row['User_District'];
    $UserGrampanchayatWard=$row['User_GrampanchayatWardNumber'];
    $UserGrampanchayatState=$row['User_State'];
   $sql="INSERT INTO electionresult (Election_Name,Election_State,Election_District,Election_Constituency,Election_Ward,Election_Party) VALUES('Grampanchayat','$UserGrampanchayatState','$UserGrampanchayatDistrict','$UserGrampanchayatContituency','$UserGrampanchayatWard','$Election_Party')";
