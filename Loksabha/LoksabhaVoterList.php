...
if (isset($_POST['CastVote'])) {
    ...
    $row = mysqli_fetch_assoc($UserData);
    $UserLoksabhaContituency=$row['User_LoksabhaConstituency'];
    $UserLoksabhaDistrict=$row['User_District'];
    $UserLoksabhaWard='NA';
    $UserLoksabhaState=$row['User_State'];
   $sql="INSERT INTO electionresult (Election_Name,Election_State,Election_District,Election_Constituency,Election_Ward,Election_Party) VALUES('Loksabha','$UserLoksabhaState','$UserLoksabhaDistrict','$UserLoksabhaContituency','$UserLoksabhaWard','$Election_Party')";
