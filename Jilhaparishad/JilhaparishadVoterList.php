...
<html>
<head>
  <title>Vote for Jilhaparishad</title>
<!--linking-->
...
// Fetching Data for Vidhansabha
 $UserJilhaparishad="SELECT * from usersignup where User_Email='".$_SESSION['UserName']."' LIMIT 1";
    ...
    $UserJilhaparishadContituency=$row['User_JilhaparishadConstituency'];
    
    
// Users Locsabhaconstituency is fetched Now List Of members fetching     
    $sql="SELECT * from addmember where SelectElectionName='Jilhaparishad' AND ConstituencyName='$UserJilhaparishadContituency'";
...
if (isset($_POST['CastVote'])) {
    ...
    $row = mysqli_fetch_assoc($UserData);
    $UserJilhaparishadContituency=$row['User_JilhaparishadConstituency'];
    $UserJilhaparishadDistrict=$row['User_District'];
    $UserJilhaparishadWard='NA';
    $UserJilhaparishadState=$row['User_State'];
   $sql="INSERT INTO electionresult (Election_Name,Election_State,Election_District,Election_Constituency,Election_Ward,Election_Party) VALUES('Jilhaparishad','$UserJilhaparishadState','$UserJilhaparishadDistrict','$UserJilhaparishadContituency','$UserJilhaparishadWard','$Election_Party')";
