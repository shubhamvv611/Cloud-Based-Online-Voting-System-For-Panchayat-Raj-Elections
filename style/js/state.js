...
function selct_district($val)
{
 ...
 if($val=='Andhra Pradesh') {
  ...
  if ($val=='Maharashtra') {
    var maharashtra = ["Akola","Amaravati","Ahmednagar","Aurangabad","Beed","Bhandara","Buldhana","Chandrapur","Dhule","Gadchiroli","Gondia","Hingoli","Jalgaon",
                                             "Jalna","Kolhapur","Latur","Mumbai (ex Bombay)","Nagapur","Nanded","Nandurbar","Nasik","Navi Mumbai","Osmanabad","Palghar",
                                             "Parbhani","Pune","Ratnagiri","Sangli","Satara","Solapur","Thana","Wardha","Washim","Yawatmal"];
   $(function() {
  var options = '';
