	...
	<div class="container-fluid ">
			<center>
				<div class="card card-transperent" style="width:25rem; border-radius:20px;">
  					...
  					<br>
  					<a href="index.php"><button type="button" class="btn btn-warning btn-lg">Home</button></a>
					<a href="CreateAccount.php"><button type="button" class="btn btn-info btn-lg">Create an Account</button></a>
  					</div>
